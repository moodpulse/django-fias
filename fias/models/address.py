...
class FIASAddressWithArea(FIASAddress):
    ...
    area = ChainedAreaField(AddrObj, on_delete=models.CASCADE, address_field='address', related_name='+')
...
class FIASHouse(models.Model):
    ...
    corps = models.CharField(_('corps'), max_length=20, blank=True, default='')
    building = models.CharField(_('building'), max_length=20, null=True, blank=True)
